...
<!--
    ...
    <meta property="og:image" content="https://falstaff.ddns.net/journalclub/images/campusnet_og.png">
                        ...
                        echo "<div>";
                            echo "<div>";
                                ...
                                if ($reference = $row["REFERENCE"]) {
                                    ...
                                    echo "<ul>";
                                        echo "<li><strong>Main reference:</strong> <a href=\"" . $reference . "\" target=\"_blank\" rel=\"noopener noreferrer\">" . $row["REFERENCE_TXT"] . "</a></li>";
                                
                                    if ($reference2 = $row["REFERENCE2"]) {

                                        echo "<li><strong>Other reference:</strong> <a href=\"" . $reference2 . "\" target=\"_blank\" rel=\"noopener noreferrer\">" . $row["REFERENCE2_TXT"] . "</a></li>";
                                    }
                                ...
                                if ($attachment = $row["PROCEEDING"]) {
                                    ...
                                    echo "<ul>";
                                        echo "<li><strong>Attachment(s):</strong> <a href=\"" . $attachment . "\" target=\"_blank\" rel=\"noopener noreferrer\">" . $row["PROCEEDING_TXT"] . "</a></li>";
                                    echo "</ul>";
                                }
                                ...
                                echo "<ul>";
                                    ...
                                    echo "<li><strong>Location:</strong> " . $row["PLACE"] . "</li>";
                                echo "</ul>";
                            echo "</div>";
                        echo "</div>";
                    echo "</article>";
